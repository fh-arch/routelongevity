...
export const translations: Record<'en' | 'tr', TranslationSet> = {
  en: {
    ...
    exploreSearchLabel: "Query Longevity Hotspots and Heritage Networks",
    exploreSearchPlaceholder: "Search by name, city (e.g., Bursa, Urla, Cappadocia), or wellness keyword (e.g., thermal, olive, sirtuin)...",
    foundMatchingLocations: "Found {count} matching locations",
    clearSearch: "Clear Search",
    heritageCategories: "Heritage Categories",
    medicalLongevityRoutes: "Medical-Longevity Routes",
    premiumLicensesActive: "Premium Licenses Active",
    realtimeSearchActive: "Real-time Search Active",
    searchResults: "Search Results",
    featuredLongevityHubs: "Featured Longevity Hubs",
    allListingPartners: "View all listing partners",
    noHubsFound: "No Longevity Hubs Found",
    noHubsFoundDesc: "We couldn't locate any wellness spots matching your search terms. Try searching for specific cities like Bursa, Urla, Cappadocia...",
    ...
    searchPlaceholderMap: "Search wellness hubs...",
    ...
    noHubsMatchFilters: "No Longevity Hubs Matched Filters",
    ...
    favoritesTitle: "Your Saved Longevity Hubs",
    favoritesSubtitle: "Curate and reference your custom biological-aging restoration directories.",
    noFavorites: "No Saved Hubs Yet",
    saveHubsPrompt: "Explore our vetted centers and tap the heart icon to start curating your custom medical longevity itinerary.",
  ...
  tr: {
    ...
    exploreSearchLabel: "Uzun Yaşam Odakları ve Miras Ağlarını Sorgula",
    exploreSearchPlaceholder: "İsim, şehir (örn: Bursa, Urla, Kapadokya) veya sağlık anahtar kelimesiyle (termal, zeytin, sirtuin...) arayın...",
    foundMatchingLocations: "{count} eşleşen konum bulundu",
    clearSearch: "Aramayı Temizle",
    heritageCategories: "Miras Kategorileri",
    medicalLongevityRoutes: "Tıbbi Uzun Yaşam Rotaları",
    premiumLicensesActive: "Seçkin Lisanslar Aktif",
    realtimeSearchActive: "Gerçek Zamanlı Arama Aktif",
    searchResults: "Arama Sonuçları",
    featuredLongevityHubs: "Öne Çıkan Sağlıklı Yaşam Merkezleri",
    allListingPartners: "Tüm kayıtlı ortakları görüntüle",
    noHubsFound: "Sağlık Merkezi Bulunamadı",
    noHubsFoundDesc: "Arama kriterlerinize uygun sağlıklı yaşam merkezi bulunamadı. Lütfen \"Bursa\", \"Urla\", \"Kapadokya\" gibi şehirleri veya \"termal\", \"zeytin\", \"merkez\" gibi kelimeleri deneyin...",
    ...
    noHubsMatchFilters: "Filtreyle Eşleşen Merkez Bulunamadı",
    ...
    saveHubsPrompt: "Denetlenmiş merkezlerimizi keşfedin ve kalp simgesine dokunarak kendi tıbbi uzun yaşam seyahat planınızı düzenlemeye başlayın.",
