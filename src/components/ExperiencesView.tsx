  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#f7fbf9] p-4 md:p-8 max-w-7xl mx-auto w-full space-y-8 animate-in fade-in duration-300">
      ...
      <div>
        ...
        <h1 className="text-3xl font-extrabold text-[#062c2b] tracking-tight">
          {t('experiencesTitle')}
        </h1>
                ...
                <div className="space-y-3">
                  <div className="flex flex-wrap gap-1.5">
                    {journey.tags.map((tag) => (
                      <span key={tag} className="text-[10px] uppercase font-bold text-brand-copper bg-[#f7fbf9] border border-brand-warm-sand/50 px-2.5 py-0.5 rounded-full">
                        {language === 'tr' 
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {participants.map((p: any) => (
                      <div
                        key={p.id}
                        className="bg-[#f7fbf9] hover:bg-brand-warm-sand/20 border border-brand-warm-sand/40 rounded-xl px-3.5 py-2.5 flex items-center gap-2.5 transition-colors"
                      >
                      ...
                      <button
                        ...
                        className={`px-4.5 py-2.5 rounded-xl border font-bold text-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer select-none ${
                          savedRouteIds.includes(journey.id)
                            ...
                            : 'bg-white border-brand-warm-sand/70 text-brand-deep-slate hover:bg-[#f7fbf9]'
                        }`}
                      >
