...
export default function FavoritesView({
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#f6fbf9] p-4 md:p-8 max-w-7xl mx-auto w-full space-y-6 animate-in fade-in duration-300">
        ...
        savedPartners.length === 0 ? (
          <div className="bg-white border border-brand-warm-sand/40 rounded-3xl p-12 text-center max-w-2xl mx-auto space-y-5 shadow-sm">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-brand-deep-slate text-brand-soft-ivory hover:bg-[#086058] font-bold text-xs rounded-xl transition-colors cursor-pointer inline-flex items-center gap-1.5 shadow-sm shadow-brand-deep-slate/10 select-none"
            >
        ...
        savedJourneys.length === 0 ? (
          <div className="bg-white border border-brand-warm-sand/40 rounded-3xl p-12 text-center max-w-2xl mx-auto space-y-5 shadow-sm">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-brand-deep-slate text-brand-soft-ivory hover:bg-[#086058] font-bold text-xs rounded-xl transition-colors cursor-pointer inline-flex items-center gap-1.5 shadow-sm shadow-brand-deep-slate/10 select-none animate-bounce"
            >
