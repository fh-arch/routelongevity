...
export default function BlogEventsModal({ isOpen, onClose, initialTab = 'blog' }: BlogEventsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#042f2c]/80 backdrop-blur-md p-4 animate-in fade-in duration-200">
      
      {/* Modal Container */}
      <div className="bg-[#f6fbf9] w-full max-w-6xl h-[92vh] md:h-[84vh] rounded-2xl overflow-hidden border border-brand-warm-sand/50 shadow-2xl flex flex-col relative animate-in zoom-in-95 duration-200">
        
        {/* Modal Top Header Bar */}
        <div className="bg-[#042f2c] text-[#f6fbf9] p-6 flex flex-col md:flex-row items-baseline md:items-center justify-between gap-4 shrink-0 border-b border-brand-warm-sand/20">
          <div className="space-y-1">
            <span className="text-[10px] tracking-widest font-mono text-[#0e7a70] uppercase font-bold">
            ...
            <div className="bg-black/20 p-1.5 rounded-2xl flex gap-1 items-center border border-white/5">
              <button
                ...
                className={`flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
                  activeSubTab === 'blog'
                    ? 'bg-[#0e655c] text-white shadow'
                    : 'text-[#f6fbf9]/70 hover:text-white'
                }`}
              >
          ...
          <button
            ...
            className="absolute top-5 right-5 p-2 rounded-full bg-white/10 hover:bg-white/20 text-[#f6fbf9] transition-colors cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
          ...
          {currentSelectedPost ? (
            <div className="space-y-6 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-6 duration-300">
              <button
                ...
                className="text-xs font-bold text-[#086058] hover:underline flex items-center gap-1.5 mb-4"
              >
              ...
              <div className="relative h-64 rounded-2xl overflow-hidden border border-brand-warm-sand/40">
                ...
                />
                <div className="absolute top-4 left-4 bg-[#0e655c] text-[#f6fbf9] text-[10px] font-bold px-2.5 py-1 rounded">
              ...
              <div className="space-y-3">
                ...
                <h3 className="text-2xl md:text-3xl font-extrabold text-[#042f2c] tracking-tight leading-tight">
              ...
              <div className="border-t border-brand-warm-sand/30 pt-6 flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className="p-2 border border-brand-warm-sand rounded-xl hover:bg-brand-warm-sand/20 text-brand-deep-slate/60 hover:text-[#042f2c] text-xs font-semibold flex items-center gap-1.5 cursor-pointer"
                  >
              ...
              {posts.map(post => (
                ...
                >
                  <div className="space-y-3">
                    ...
                    <h4 className="font-bold text-brand-deep-slate text-sm leading-snug line-clamp-2 hover:text-[#086058] transition-colors cursor-pointer font-sans" onClick={() => setSelectedPost(post)}>
                      {post.title}
                    </h4>
                  ...
                  <button
                    ...
                    className="pt-2 text-[11px] font-bold text-[#086058] hover:text-brand-deep-slate flex items-center gap-1 cursor-pointer"
                  >
            ...
            <div className="space-y-6">
              <div className="bg-[#0e7a70]/10 border border-[#0e7a70]/20 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="space-y-0.5 max-w-lg">
                  <p className="text-xs font-bold text-[#086058] text-left">
                ...
                <div className="bg-white border border-[#0e7a70]/30 text-[#086058] font-mono text-xs font-bold px-3 py-1.5 rounded-xl shrink-0">
                  {language === 'tr' ? 'Epigenetik & Keşif' : 'Epigenetics & Immersion'} 
                </div>
              </div>

              {bookingSuccessId && (
                <div className="bg-[#79c9b8]/10 border border-[#79c9b8]/30 p-4 rounded-2xl flex items-center gap-3 text-xs text-brand-deep-slate animate-in slide-in-from-top-1">
                  <CheckCircle className="w-5 h-5 text-[#79c9b8]" />
                  <div>
                    <h5 className="font-bold text-[#042f2c]">
                    ...
                    >
                      <div className="space-y-3">
                        <div className="flex justify-between items-start gap-2">
                          <span className="text-[9px] uppercase font-bold text-[#f6fbf9] bg-[#0e7a70] px-2 py-0.5 rounded">
                            {ev.city}
                          </span>
                          <span className="text-[10px] text-[#0e655c] bg-[#0e655c]/5 border border-[#0e655c]/20 px-2.5 py-0.5 rounded-full font-bold">
                      ...
                      {isBooking ? (
                        <form onSubmit={(e) => handleBookingSubmit(e, ev.id)} className="border-t border-brand-warm-sand/20 pt-4 mt-2 space-y-2">
                          ...
                          <input
                            ...
                            className="w-full text-xs p-2.5 bg-[#f6fbf9] border border-brand-warm-sand/60 rounded-xl focus:outline-none focus:border-[#0e7a70]"
                          />
                          <input
                            type="email"
                            required
                          ...
                          <div className="flex gap-2 pt-1">
                            ...
                            <button
                              type="submit"
                              disabled={isBookingSubmitting}
                              className="flex-1 py-1.5 bg-[#0e7a70] hover:bg-[#0e7a70]/90 disabled:opacity-50 text-brand-deep-slate font-bold text-xs rounded-lg cursor-pointer"
                            >
                              {isBookingSubmitting
                          ...
                          <button
                            ...
                            className={`px-4 py-2 font-bold text-xs rounded-xl transition-all cursor-pointer select-none ${
                              bookingSuccessId === ev.id
                                ...
                                : 'bg-brand-deep-slate hover:bg-[#086058] text-brand-soft-ivory'
                            }`}
                          >
                            {bookingSuccessId === ev.id 
        ...
        {/* Modal Footer */}
        <div className="bg-[#f6fbf9] border-t border-brand-warm-sand/30 p-4 shrink-0 flex justify-between items-center text-[10px] text-brand-deep-slate/40 font-mono">
